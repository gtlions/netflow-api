...
class CreateIPSevenLayerAntiConfig(ActionBase):
    '''创建高防IP七层防护配置'''
    ...
    def run(self):
        ...
        for config in configs_dict:
            ...
            duplicate = self.application.dbcur.queryone(sql, (ip, domain, port,))[0]
            if duplicate:
        ...
        self.application.dbcur.insert_dict('t_slb_seven_layer', seven_layer_info)
        data_info = {}
